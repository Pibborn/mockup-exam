...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{subparts}
            \subpart Read the dataset description file \verb|breast-cancer-wisconsin.names| carefully;
            \subpart Preprocess the data;
            \subpart Train various models, including at least one DBSCAN model;
        ...
        \end{subparts} 
        \part In the \verb|ex2_classification.py| exercise, you are expected to complete a script that creates a neural network model from a Python class, also training it on the breast cancer dataset.
        \begin{subparts}
            \subpart Preprocess the data (using the same Python functions you might have written to solve exercise 1 by including them in this file will be worth extra points);
            \subpart Read and understand the \verb|MultiLayerNetwork| class you will find in the \verb|utils.py| file;
